...
tpanel_definition::tresolution::tresolution(const config& cfg)
	...
	, top_border(cfg["top_border"].to_int() * twidget::hdpi_scale)
	, bottom_border(cfg["bottom_border"].to_int() * twidget::hdpi_scale)
	, left_border(cfg["left_border"].to_int() * twidget::hdpi_scale)
	, right_border(cfg["right_border"].to_int() * twidget::hdpi_scale)
{
/*WIKI
