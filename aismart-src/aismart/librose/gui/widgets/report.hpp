...
public:
	...
	void erase_item(int at = npos, bool auto_select = true);
	void clear();
	void hide_children();

	void set_item_visible(int at, bool visible, bool auto_select = true);
	bool get_item_visible(int at) const;
	void set_item_visible(const tcontrol& widget, bool visible, bool auto_select = true);
	bool get_item_visible(const tcontrol& widget) const;
	void set_item_label(int at, const std::string& label);
	void set_item_label(tcontrol& widget, const std::string& label);
