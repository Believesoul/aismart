...
#define gc_is_estimated(value)			((value) != twidget::npos && (value) >= GC_PRECISE_DISTANCE_THRESHOLD)
#define gc_is_precise(value)			((value) != twidget::npos && (value) < GC_PRECISE_DISTANCE_THRESHOLD)
